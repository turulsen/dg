...
8. ~~Multi-source character sheet import ("Phase 2") + a roster to browse them.~~ Mostly done — see Import Character and Agent Roster above. Official/pigeon-labs-stack PDF import, Google Sheet import, and the Agent Roster are all live. Still open: **[Kappa Black](https://www.kappablack.com/)** import (JSON/TOML/PDF) — blocked on getting a real sample export to build against, since kappablack.com and its GitHub source (`troygoode/kappablack`) are both unreachable from this hub's dev sandbox.
