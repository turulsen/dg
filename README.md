...
### Import Character ("Phase 2")

Several agents in this campaign were built on other tools before this hub existed. `stats/`'s Advanced — Export & Import section (same place the Foundry VTT / Printable Sheet / Google Sheet exports already lived) now has import counterparts for the main ones:
...
8. ~~Multi-source character sheet import ("Phase 2") + a roster to browse them.~~ Done — see Import Character and Agent Roster above. Official/pigeon-labs-stack PDF import, Google Sheet import, **[Kappa Black](https://www.kappablack.com/)** TOML/JSON import, and the Agent Roster are all live.
